...
from ccxt.base.errors import OverloadedError
from ccxt.base.errors import MaintenanceError
    ...
    def handle_errors(self, code, reason, url, method, headers, body):
        if code >= 400:
            if body and body[0] == '{':
                ...
                if status == -208:
                    raise OverloadedError(self.id + ' ' + self.json(response))
                elif status == -204 or status == -2:
                    raise MaintenanceError(self.id + ' ' + self.json(response))
